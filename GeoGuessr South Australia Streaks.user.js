// ==UserScript==
// @name         GeoGuessr South Australia Streaks
// @description  South Australia region streaks (adapted from miraclewhips's county streak script)
// @version      0.1
...
// @license      MIT
// @require      https://github.com/macca7224/south-australia-streaks/raw/main/districts.user.js
// ==/UserScript==
...
const stopRound = async () => {
	...
	let responseGuess = getDistrict(guess);
	let responseLocation = getDistrict(location);
